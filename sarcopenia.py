...
"""
    ...
    # Crear un enlace que redirecciona al hacer clic
    st.markdown(f"[{link_text_1}]({link_url_1})")
...
Cruz-Jentoft AJ, Bahat G, Bauer J, Boirie Y, Bruyère O, Cederholm T, et al. Sarcopenia: revised European consensus on definition and diagnosis. Age Ageing 2019;48(1):16-31. DOI: 10.1093/ageing/afy169/5126243 https://academic.oup.com/ageing/article/48/1/16/5126243?login=true 
"""
)
